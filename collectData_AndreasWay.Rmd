...
Repeat the steps above, now with all collected data
Code to separate out the predictions into different amplitudes has since been deleted accidentally,
but all predictions are stored in 
